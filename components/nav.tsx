...
const links: LinkItem[] = [
  {
    ...
    label: "Instagram",
    weblink: `https://www.instagram.com/nimanizky/`,
  },
  {
    href1: (
      <svg
        ...
        <ul className="md:flex justify-between items-center space-x-2 mr-3 hidden">
          {links.map((link) => (
            <li key={link.label}>
              <a
                href={`${link.weblink}`}
                className="inline-block type-meta py-2 pr-2 hover:shadow-inner transform pl-1 rounded-md transition duration-300 ease-in-out hover:bg-gray-300 mt-4 md:mt-0"
              >
                <div className="flex">
                  {link.href1}
