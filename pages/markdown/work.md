...
emg_photo_url: goto.jpeg
highlights:
  - GoTo Personalization Platform (CDO Group)
  - Led database migration for the campaign team and acted as the team main contact for the GoTo x Tencent ODS transition, reducing disk usage by 30% and improving write performance.
  - Central authorization mechanism based on Role Based Access Control for campaign process.
  - Develop extended features to support campaign targeting for the Saver Program in food delivery incentives.
---
